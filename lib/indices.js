...
exports.tops = function (indice, options, callback) {
  ...
  return promisedQuery('GET', `${services.logs}/${indice}/tops`, options).then(res => {
    return res || Promise.reject(new Error('Invalid response'));
  });
};
