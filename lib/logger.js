...
module.exports = function createLogger(options) {
  ...
  return {
    ...
    skip(message) { logger.error(log('Skipped', 'yellow', message)); },
    loading(message) { logger.error(log('Loading', 'blue', message)); },
    loaded(message) { logger.error(log('Loaded', 'green', message)); },
